...
from QRNN.model import QRNN, count_parameters
from QRNN.quantum import tensor
from QRNN import data, datasets
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="QRNN Training Script", formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument(
    ...
    parser_train.add_argument("--stages", metavar="S", type=int, default=2, help="QRNN cell stages")
    parser_train.add_argument(
